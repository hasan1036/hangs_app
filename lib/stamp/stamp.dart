...
import 'package:hangs_app_user/stamp/stamp_select_model.dart';
import 'package:image_picker/image_picker.dart';
import '../../../utils/app_color.dart';
import '../Upload/home_two_upload_button.dart';
import '../stampQR/stamp_qr.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>HomeTwoUploadButton()));
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: (){
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>StampSelectModel()));
////add korte hbe
                            ...
                            child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                    style: buttonfive,
                                    onPressed: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (context)=>StampQR()));
                                      // Get.to(const StampQR());
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Padding(padding: const EdgeInsets.fromLTRB(230, 0, 0, 0),
                      child: Container(
