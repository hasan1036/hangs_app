...
import 'stamp_cancel_qr.dart';
import 'store_screen.dart';


class StoreStampCancel extends StatefulWidget {
  const StoreStampCancel({Key? key}) : super(key: key);

  @override
  State<StoreStampCancel> createState() => _StoreStampCancel();
}

class _StoreStampCancel extends State<StoreStampCancel> {
  File? pickedImage;
